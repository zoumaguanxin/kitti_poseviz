...
int main(int argc, char **argv) {
	...
	string entry;
	entry=argv[1];
	//string path="/data/datasets/KITTI/results/legoloamjq/result_trace/"+entry+"_integrated_init.txt";
	// string path="/data/datasets/KITTI/results/integrated_init/"+entry+"_integrated_init_new.txt";
	string path = "/media/shawn/ubuntu_data/datasets/KITTI_raw/results/floam_lidar_odom_raw/"+entry+".txt";
	//string path="/data/datasets/KITTI/results/legoloamjq/01_integrated_init_new.txt";
	//string path="../data/lego_loam/00_camera_2_camera_init.txt";
	string posesdir="/media/shawn/ubuntu_data/datasets/KITTI_raw/results/floam/"+entry+".txt";
	//string posesdir="/data/datasets/KITTI/results/lego_loam/"+entry+".txt";


	//groud truth
	string path1="/media/shawn/ubuntu_data/datasets/KITTI_raw/GroudTruth/poses/"+entry+".txt";
	
	//calib file
	string calibPath="/media/shawn/ubuntu_data/datasets/KITTI/data_calibration/sequences/"+entry+"/calib.txt";
	...
	std::cout<<"tf size: "<<my_tfs.size()<<std::endl;
...
/*
	for(auto &position:positions2camera0)
	{
		position.y=positions2camera0.points[0].y;
	}
*/
